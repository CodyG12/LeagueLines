...
// Ported from https://reactbits.dev/backgrounds/beams (MIT) — stacked, noise-displaced
// planes lit like ribbons of light, rendered with Three.js / @react-three/fiber.
  ...
  return (
    <CanvasWrapper>
      <group rotation={[0, 0, degToRad(rotation)]}>
        ...
        <DirLight color={lightColor} position={[0, 3, 10]} intensity={2.5} />
        <DirLight color={secondaryLightColor} position={[6, -4, 6]} intensity={1.1} />
      </group>
